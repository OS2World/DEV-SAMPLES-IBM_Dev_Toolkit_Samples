...
#-------------------------------------------------------------------
$(OBJDIR)\textfldr.res: textfldr.rc textfldr.ih
                $(RC) $(RCFLAGS) $(@B).rc $@

textfldr.h:   textfldr.idl

textfldr.def: textfldr.idl

textfldr.ih:  textfldr.idl

textfldr.c:   textfldr.idl

$(OBJDIR)\textfldr.obj:    textfldr.c    textfldr.ih  textfldr.h textfldr.idl
   $(CC) -c $(CFLAGS) $(CINCLUDE) $(DLLCFLAGS) -I. -Fo"$(OBJDIR)\$(@B).obj" $(@B).c

$(EXEDIR)\textfldr.dll: textfldr.def $(OBJS) $(OBJDIR)\textfldr.res
   -$(CREATE_PATH)
