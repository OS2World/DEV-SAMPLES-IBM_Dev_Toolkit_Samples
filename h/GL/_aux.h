/* @(#)52	1.2  R2/OPENGL/test/aux/aux.h, gltest, r5gos325, 9334325c 8/25/93 22:37:34 */
/*
 *   COMPONENT_NAME: GLTEST
 *
 *   FUNCTIONS: AUX_SETCOLOR
 *		AUX_WIND_HAS_ACCUM
 *		AUX_WIND_HAS_ALPHA
 *		AUX_WIND_HAS_DEPTH
 *		AUX_WIND_HAS_STENCIL
 *		AUX_WIND_IS_DIRECT
 *		AUX_WIND_IS_DOUBLE
 *		AUX_WIND_IS_INDEX
 *		AUX_WIND_IS_INDIRECT
 *		AUX_WIND_IS_RGB
 *		AUX_WIND_IS_SINGLE
 *		auxExposeFunc
 *		auxIdleFunc
...
/* No Way in PM maybe auxPMhab() and auxPMWindow
