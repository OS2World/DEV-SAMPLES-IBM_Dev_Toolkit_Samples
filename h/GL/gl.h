/* @(#)67	1.12  src/gos/3d/OPENGL/include/GL/gl.h, glxlib, gos41C, 9530B 7/20/95 15:15:43 */
/*
 *   COMPONENT_NAME: GLXLIB
 *
 *   FUNCTIONS:
 *
 *   ORIGINS: 21,27
...
#endif
#if defined (METAWARE)
#define APIENTRY  /* needed for Metaware compiler */
#endif
#else /* !OS2 */
#define APIENTRY
#endif /* OS2 */
...
#ifdef _AIX
#define GL_SUBPIXEL_HINT_IBM              103001
#endif
...
extern void APIENTRY glColorPointerEXT (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
...
extern void APIENTRY glDepthRange (GLclampd near, GLclampd far);
...
extern void APIENTRY glFrustum (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near, GLdouble far);
...
extern void APIENTRY glGetPointervEXT (GLenum pname, GLvoid* *params);
...
extern void APIENTRY glIndexPointerEXT (GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
...
extern void APIENTRY glNormalPointerEXT (GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
extern void APIENTRY glOrtho (GLdouble left, GLdouble right, GLdouble bottom, GLdouble top, GLdouble near, GLdouble far);
...
extern void APIENTRY glTexCoordPointerEXT (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
...
extern void APIENTRY glTexImage2D (GLenum target, GLint level, GLint components, GLsizei width, GLsizei height, GLint border, GLenum format, GLenum type, const GLvoid *pixels);
...
extern void APIENTRY glTexSubImage1DEXT (GLenum target, GLint level, GLint xoffset, GLsizei width, GLenum format, GLenum type, const GLvoid *pixels);
extern void APIENTRY glTexSubImage2DEXT (GLenum target, GLint level, GLint xoffset, GLint yoffset, GLsizei width, GLsizei height, GLenum format, GLenum type, const GLvoid *pixels);
...
extern void APIENTRY glVertexPointerEXT (GLint size, GLenum type, GLsizei stride, GLsizei count, const GLvoid *pointer);
