/* @(#)68	1.5  src/gos/3d/OPENGL/include/GL/glu.h, glxlib, gos41C 7/25/95 10:01:43  */
/*
 *   COMPONENT_NAME: glu
 *
 *   FUNCTIONS: none
...
extern void APIENTRY gluPerspective (GLdouble fovy, GLdouble aspect, GLdouble near, GLdouble far);
