...
#define ALERT_BadSpareB         (ALERT_BASE + 13)
        /*
         * A critical sector error was detected on drive %1.  Back up the drive.  No data was lost.
         */

#define ALERT_NoHotFix          (ALERT_BASE + 14)
        /*
         * A bad sector on drive %1 cannot be fixed .  Run CHKDSK /F on the drive.
         */

#define ALERT_BadVolume         (ALERT_BASE + 15)
        /*
         * Drive %1 is experiencing severe disk errors.  Back up the drive immediately.
         */


#define  ALERT_DirAlerts_Threshold_2      (ALERT_BASE + 16)
        /*
         * The write operation on server %1 was successful, but the
         * directory size crossed a threshold.  The remaining space
         * in the directory is %2 KB.
         */

#define  ALERT_DirAlerts_DirFull_2        (ALERT_BASE + 17)
        /*
         * There was not enough space within the directory tree to perform
         * a write operation on server %1.
         */

#define ALERT_DlimNoHeap                  (ALERT_BASE + 18)
       /*
        * The 386 HPFS server failed to enable directory limits
        * on drive %1 because of insufficient heap space.  The
        * drive is still operational.
        */

#define ALERT_DlimDskErr                  (ALERT_BASE + 19)
       /*
        * The 386 HPFS server failed to enable directory
        * limits on drive %1 because of a disk error.  The drive
        * is still operational.
        */

#define ALERT_PowerOut          (ALERT_BASE + 20)
        /*
         * A power failure was detected on %1 at %2.  The server has been paused.
         */
...
#define  ALERT_DirAlerts_Threshold        (ALERT_BASE+23)
        /*
         * The write operation was successful, but directory %1 on server
         * %2 crossed a threshold.  The remaining space in the directory is
         * %3 KB.
         *
         * (%1 is the directory name)
         */

#define  ALERT_DirAlerts_DirFull          (ALERT_BASE+24)
        /*
         * There was not enough space within the directory tree
         * %1 on server %2 to perform a write operation.
         *
         * (%1 is the directory name)
         */
